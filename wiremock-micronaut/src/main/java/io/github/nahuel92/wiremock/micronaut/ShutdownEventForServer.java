 ...
 */
class ShutdownEventForServer implements ApplicationEventListener<ShutdownEvent> {
    ...
    ShutdownEventForServer(final WireMockServer wireMockServer, final ConfigureWireMock options) {
